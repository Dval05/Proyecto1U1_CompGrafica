...
{
    public partial class frmGema2 : Form
    {
        // --- 1. VARIABLES DE ESTADO ---
        private CGema2 objGema = new CGema2();
        ...
        // --- 3. EVENTO LOAD ---
        private void frmGema2_Load(object sender, EventArgs e)
        {
        ...
        private void btnGraficar_Click(object sender, EventArgs e)
        {
            ...
            // La figura se dibuja centrada en el origen, así que el pivote debe ser (0, 0)
        ...
        private void frmGema2_KeyDown(object sender, KeyEventArgs e)
        {
