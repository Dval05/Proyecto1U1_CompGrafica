...
{
    public partial class fmrHexagonoConcentrico : Form
    {
        // --- 1. VARIABLES DE ESTADO ---
        private CHexagonoConcentrico objHexagono = new CHexagonoConcentrico();
        ...
        // --- 3. EVENTO LOAD ---
        private void fmrHexagonoConcentrico_Load(object sender, EventArgs e)
        {
        ...
        {
            if (!objHexagono.ReadData(txtSide))
                return;
        ...
        // --- 5. MÉTODO DE DIBUJO CENTRAL ---
        private void RedrawFigure()
        {
            objHexagono.DibujarHexagono(picCanvas, obTransformation);
        }

        // --- 6. BOTONES DE TRANSFORMACIÓN ---
        ...
        // --- 7. MANEJADORES DE INPUT ---
        private void fmrHexagonoConcentrico_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btnResetear_Click(object sender, EventArgs e)
        {
            ...
            objHexagono.InitializeData(txtSide, picCanvas);
        }

        private void btnSalir_Click(object sender, EventArgs e)
        {
            objHexagono.CloseForm(this);
        }
